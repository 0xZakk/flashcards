relative_require '../app'
relative_require 'connection'
...
spanish_foods_deck = Decks.find_by(name: "Spanish Foods")
spanish_foods_cards = spanish_foods_deck.card.create([
...
spanish_travel_deck = Decks.find_by(name: "Spanish Travel")
spanish_travel_cards = spanish_travel_deck.card.create([
